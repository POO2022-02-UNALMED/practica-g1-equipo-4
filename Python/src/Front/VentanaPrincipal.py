    ...
    #Se organizan los frames
        ...
        def cambiarNombreCartelera(event,diasbox,nombreCartelera):
            ...
            if diasbox.get()=="Lunes":
                framePeliculas.config(text="Película 1")
            elif diasbox.get()=="Martes":
                framePeliculas.config(text="Película 2")
            elif diasbox.get()=="Miércoles":
                framePeliculas.config(text="Película 3")
            elif diasbox.get()=="Jueves":
                framePeliculas.config(text="Película 4")
            elif diasbox.get()=="Viernes":
                framePeliculas.config(text="Película 5")   
            elif diasbox.get()=="Sábado":
                framePeliculas.config(text="Película 6")
            elif diasbox.get()=="Domingo":
                framePeliculas.config(text="Película 7")
