...
class VentanaSecundaria(tk.Tk):
    ...
    #Se organizan los frames
        ...
        seleccion= Label(frameCartelera, text="Por favor seleccione el día", font=("Constantia", 13), bg= "bisque")
        descCartelera = Label(frameCartelera, text="La Cartelera el día de hoy", font=("Constantia", 18), background= 'salmon')
        framePeliculas = Label(frameCartelera,text="Aquí aparcerá la cartelera del día seleccionado",bg="indian red", font=("Comic Sans MS", 20))
